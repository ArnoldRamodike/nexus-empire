...
const DashboardTotalCountCard = ({
  ...
  const config: AreaConfig = {
    ...
    areaStyle: () => {
      return{
        fill: `'(170) 0:#fff 0.2${secondaryColor} 1:${primaryColor}`
      }
    }
  }
  ...
  return (
    ...
    >
      ...
      <div style={{display: 'flex', justifyContent: 'space-between',}}>
        <Text 
          size='xxxl' strong style={{flex:1, whiteSpace: 'nowrap', flexShrink: 0, alignItems: 'start', 
          marginLeft: '48px', fontVariantNumeric: 'tabular-nums'}}>
          {isLoading? (
